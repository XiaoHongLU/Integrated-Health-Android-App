...
import heartrace.ImageProcessing;
...
public class HeartRaceFragment extends Fragment {
	
	public HeartRaceFragment(){}
    ...
    static String data_date,data_step,data_bmi,data_height,data_weight,data_name;
    static int tmp;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_heartrace, container, false);
        ...
        if(tmp>0)
        {
        	DB.putInformation(DB,data_name,data_date,data_step,data_weight,data_height,data_bmi,String.valueOf(tmp));
        }
        return rootView;
    }
